...
export default class IdleSubStateMachine extends DirectionSubStateMachine {
  constructor(fsm: StateMachine, spriteAnimation: SpriteAnimation) {
    ...
    this.stateMachines.set(DIRECTION_ENUM.BOTTOM, new State(spriteAnimation, 'door_idle_bottom'));
    this.stateMachines.set(DIRECTION_ENUM.LEFT, new State(spriteAnimation, 'door_idle_left'));
    this.stateMachines.set(DIRECTION_ENUM.RIGHT, new State(spriteAnimation, 'door_idle_right'));
  }
}
